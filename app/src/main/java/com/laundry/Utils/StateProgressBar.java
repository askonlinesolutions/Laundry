...
/**
    ...
    private com.kofigyan.stateprogressbar.StateProgressBar.Animator mAnimator;
...
/**
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs, com.kofigyan.stateprogressbar.R.styleable.StateProgressBar, defStyle, 0);

            mBackgroundColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateBackgroundColor, mBackgroundColor);
            mForegroundColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateForegroundColor, mForegroundColor);
            mStateNumberBackgroundColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateNumberBackgroundColor, mStateNumberBackgroundColor);
            mStateNumberForegroundColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateNumberForegroundColor, mStateNumberForegroundColor);
            mCurrentStateDescriptionColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_currentStateDescriptionColor, mCurrentStateDescriptionColor);
            mStateDescriptionColor = a.getColor(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateDescriptionColor, mStateDescriptionColor);

            mCurrentStateNumber = a.getInteger(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_currentStateNumber, mCurrentStateNumber);
            mMaxStateNumber = a.getInteger(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_maxStateNumber, mMaxStateNumber);

            mStateSize = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateSize, mStateSize);
            mStateNumberTextSize = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateTextSize, mStateNumberTextSize);
            mStateDescriptionSize = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateDescriptionSize, mStateDescriptionSize);
            mStateLineThickness = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateLineThickness, mStateLineThickness);

            mCheckStateCompleted = a.getBoolean(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_checkStateCompleted, mCheckStateCompleted);
            mAnimateToCurrentProgressState = a.getBoolean(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_animateToCurrentProgressState, mAnimateToCurrentProgressState);
            mEnableAllStatesCompleted = a.getBoolean(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_enableAllStatesCompleted, mEnableAllStatesCompleted);

            mDescTopSpaceDecrementer = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_descriptionTopSpaceDecrementer, mDescTopSpaceDecrementer);
            mDescTopSpaceIncrementer = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_descriptionTopSpaceIncrementer, mDescTopSpaceIncrementer);

            mAnimDuration = a.getInteger(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_animationDuration, mAnimDuration);
            mAnimStartDelay = a.getInteger(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_animationStartDelay, mAnimStartDelay);

            mIsStateNumberDescending = a.getBoolean(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_stateNumberIsDescending, mIsStateNumberDescending);

            mMaxDescriptionLine = a.getInteger(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_maxDescriptionLines, mMaxDescriptionLine);

            mDescriptionLinesSpacing = a.getDimension(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_descriptionLinesSpacing, mDescriptionLinesSpacing);

            mJustifyMultilineDescription = a.getBoolean(com.kofigyan.stateprogressbar.R.styleable.StateProgressBar_spb_justifyMultilineDescription, mJustifyMultilineDescription);
    ...
    public void setCurrentStateNumber(com.kofigyan.stateprogressbar.StateProgressBar.StateNumber currentStateNumber) {
    ...
    public void setMaxStateNumber(com.kofigyan.stateprogressbar.StateProgressBar.StateNumber maximumState) {
    ...
    private void initStateProgressBar(Context context) {
        ...
        mBackgroundColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.background_color);
        mForegroundColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.foreground_color);
        mStateNumberBackgroundColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.background_text_color);
        mStateNumberForegroundColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.foreground_text_color);
        mCurrentStateDescriptionColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.foreground_color);
        mStateDescriptionColor = ContextCompat.getColor(context, com.kofigyan.stateprogressbar.R.color.background_text_color);
        ...
        mMaxStateNumber = com.kofigyan.stateprogressbar.StateProgressBar.StateNumber.FIVE.getValue();
        mCurrentStateNumber = com.kofigyan.stateprogressbar.StateProgressBar.StateNumber.ONE.getValue();
    ...
    private void drawStateNumberText(Canvas canvas, int noOfCircles) {
        ...
        for (int i = 0; i < noOfCircles; i++) {
            ...
            if (mCheckStateCompleted && isChecked) {
                canvas.drawText(getContext().getString(com.kofigyan.stateprogressbar.R.string.check_icon), xPos, yPos, innerPaintType);
            } else {
                if (mIsStateNumberDescending)
