        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Toast.makeText(CurrentLocationMapActivity.this,currentLocation.getLatitude()+" "+currentLocation.getLongitude(),Toast.LENGTH_SHORT).show();
                    SupportMapFragment supportMapFragment= (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
                    supportMapFragment.getMapAsync(CurrentLocationMapActivity.this);
                }else{
                    Toast.makeText(CurrentLocationMapActivity.this,"No Location recorded",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        switch (requestCode) {
            case LOCATION_REQUEST_CODE:
                if (grantResult.length > 0 && grantResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(CurrentLocationMapActivity.this,"Location permission missing",Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }*/
...
//                clicked
                ...
                String city = listAddresses.get(0).getFeatureName();
                binding.topLocationEt.setText(address);
                binding.locationTv.setText(country);
                binding.landmarkEt.setText(city);
                binding.houseNoEt.setText(landmark);
//                markerOptions.title("" + latLng + "," + subLocality + "," + state
//                        + "," + country);
//                ""+state+"," +city+","+sector+","+subLocality+","+landmark
            }
